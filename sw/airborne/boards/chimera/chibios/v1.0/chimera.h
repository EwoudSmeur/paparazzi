...
#define DSHOT_SERVO_4_GPIO GPIOD
#define DSHOT_SERVO_4_PIN GPIO12
#define DSHOT_SERVO_4_AF GPIO_AF2
#define DSHOT_SERVO_4_DRIVER DSHOTD4
#define DSHOT_SERVO_4_CHANNEL 0

#define DSHOT_SERVO_5 5
#define DSHOT_SERVO_5_GPIO GPIOD
#define DSHOT_SERVO_5_PIN GPIO13
#define DSHOT_SERVO_5_AF GPIO_AF2
#define DSHOT_SERVO_5_DRIVER DSHOTD4
#define DSHOT_SERVO_5_CHANNEL 1

#define DSHOT_SERVO_6 6
#define DSHOT_SERVO_6_GPIO GPIOD
#define DSHOT_SERVO_6_PIN GPIO14
#define DSHOT_SERVO_6_AF GPIO_AF2
#define DSHOT_SERVO_6_DRIVER DSHOTD4
#define DSHOT_SERVO_6_CHANNEL 2

#define DSHOT_SERVO_7 7
#define DSHOT_SERVO_7_GPIO GPIOD
#define DSHOT_SERVO_7_PIN GPIO15
#define DSHOT_SERVO_7_AF GPIO_AF2
#define DSHOT_SERVO_7_DRIVER DSHOTD4
#define DSHOT_SERVO_7_CHANNEL 3
