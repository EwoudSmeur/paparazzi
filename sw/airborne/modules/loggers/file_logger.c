...
static void file_logger_write_row(FILE *file)
{
  ...
  struct FloatVect3 *accel = stateGetAccelBody_f();
  struct NedCoor_f Vect3 *accel_ned = stateGetAccelNed_f();
  ...
  fprintf(file, "%f,%f,%f,", speed_sp.x, speed_sp.y, speed_sp.z);
  fprintf(file, "%d,%d,%d,", guidance_h.ref.speed.x, guidance_h.ref.speed.y, guidance_v_zd_ref);
  ...
  fprintf(file, "%f,%f,%f,", speed_ned->x, speed_ned->y, speed_ned->z);
  fprintf(file, "%f,%f,%f,", accel_ned->x, accel_ned->y, accel_ned->z);
