...
//     high_speed_logger_spi_link_data.gps_speedy = RATE_BFP_OF_REAL(indi_u.q);
    ...
    high_speed_logger_spi_link_data2.acc_x      = imu.accel.x;
    high_speed_logger_spi_link_data2.acc_y      = imu.accel.y;
    high_speed_logger_spi_link_data2.acc_z      = imu.accel.z;
